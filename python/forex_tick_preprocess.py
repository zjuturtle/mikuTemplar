...
if __name__ == '__main__':
    ...
    parser.add_argument('--pipettes_factor', help='pipettes factor.', type=int, required=False, default=100000)
    parser.add_argument('--pipettes_offset', help='pipettes offset.', type=int, required=False, default=-1)
